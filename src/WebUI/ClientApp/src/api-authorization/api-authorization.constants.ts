...
export const ApplicationName = 'MkPingPong.WebUI';
...
let applicationPaths: ApplicationPathsType = {
  ...
  ApiAuthorizationClientConfigurationUrl: API_BASE_URL + `/_configuration/${ApplicationName}`,
  ...
  IdentityRegisterPath: API_BASE_URL + '/Identity/Account/Register',
  IdentityManagePath: API_BASE_URL + '/Identity/Account/Manage'
};

        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TicketOrders_Customers",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TicketMasterId = table.Column<Guid>(nullable: false),
                    TicketOrderId = table.Column<Guid>(nullable: false),
                    UnitPrice = table.Column<decimal>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TicketOrderDetails", x => new { x.TicketOrderId, x.TicketMasterId });
                    table.ForeignKey(
                        name: "FK_TicketOrderDetails_TicketMasters",
                        column: x => x.TicketMasterId,
                        principalTable: "TicketMasters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TicketOrderDetails_TicketOrders",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketOrderDetails_TicketMasterId",
                table: "TicketOrderDetails",
                column: "TicketMasterId");

            migrationBuilder.CreateIndex(
                name: "IX_TicketOrders_CustomerId",
                table: "TicketOrders",
                column: "CustomerId");
